...
def main():
  ...
  metadata_population_arguments.add_argument("--amplicon_primer_scheme", help="Amplicon primer scheme", nargs="*")
  metadata_population_arguments.add_argument("--amplicon_size", help="Amplicon size", nargs="*")
  metadata_population_arguments.add_argument("--authors", help="Authors of the study", nargs="*")
  metadata_population_arguments.add_argument("--bioproject_accession", help="Bioproject accession number", nargs="*")
  metadata_population_arguments.add_argument("--continent", help="Continent of the sample", nargs="*")
  metadata_population_arguments.add_argument("--country", help="Country of the sample", nargs="*")
  metadata_population_arguments.add_argument("--gisaid_submitter", help="GISAID submitter", nargs="*")
  metadata_population_arguments.add_argument("--host_disease", help="Disease of the host", nargs="*")
  metadata_population_arguments.add_argument("--instrument_model", help="Instrument model", nargs="*")
  metadata_population_arguments.add_argument("--isolation_source", help="Source of isolation", nargs="*")
  metadata_population_arguments.add_argument("--library_layout", help="Library layout", nargs="*")
  metadata_population_arguments.add_argument("--library_selection", help="Library selection method", nargs="*")
  metadata_population_arguments.add_argument("--library_source", help="Library source", nargs="*")
  metadata_population_arguments.add_argument("--library_strategy", help="Library strategy", nargs="*")
  metadata_population_arguments.add_argument("--metadata_organism", help="Organism name for metadata population", nargs="*")
  metadata_population_arguments.add_argument("--purpose_of_sequencing", help="Purpose of sequencing", nargs="*")
  metadata_population_arguments.add_argument("--seq_platform", help="Sequencing platform", nargs="*")
  metadata_population_arguments.add_argument("--state", help="State of the sample", nargs="*")
  metadata_population_arguments.add_argument("--submitter_email", help="Submitter email", nargs="*")
  metadata_population_arguments.add_argument("--submitting_lab", help="Submitting laboratory", nargs="*")
  metadata_population_arguments.add_argument("--submitting_lab_address", help="Address of the submitting laboratory", nargs="*") 
