...
def main():
  ...
  customization_arguments.add_argument("--authors", help="Authors of the study", default="", nargs="?")
  customization_arguments.add_argument("--bioproject_accession", help="Bioproject accession number", default="", nargs="?")
  customization_arguments.add_argument("--continent", help="Continent of the sample", default="", nargs="?")
  customization_arguments.add_argument("--country", help="Country of the sample", default="", nargs="?")
  customization_arguments.add_argument("--host_disease", help="Disease of the host", default="", nargs="?")
  customization_arguments.add_argument("--isolation_source", help="Source of isolation", default="", nargs="?")
  customization_arguments.add_argument("--library_selection", help="Library selection method", default="", nargs="?")
  customization_arguments.add_argument("--library_source", help="Library source", default="", nargs="?")
  customization_arguments.add_argument("--library_strategy", help="Library strategy", default="", nargs="?")
  customization_arguments.add_argument("--purpose_of_sequencing", help="Purpose of sequencing", default="", nargs="?")
  customization_arguments.add_argument("--state", help="State of the sample", default="", nargs="?")
  customization_arguments.add_argument("--submitting_lab", help="Submitting laboratory", default="", nargs="?")
  customization_arguments.add_argument("--submitting_lab_address", help="Address of the submitting laboratory", default="", nargs="?")
  customization_arguments.add_argument("--amplicon_primer_scheme", help="Amplicon primer scheme", default="", nargs="?")
  customization_arguments.add_argument("--amplicon_size", help="Amplicon size", default="", nargs="?")
  customization_arguments.add_argument("--instrument_model", help="Instrument model", default="", nargs="?")
  customization_arguments.add_argument("--library_layout", help="Library layout", default="", nargs="?")
  customization_arguments.add_argument("--seq_platform", help="Sequencing platform", default="", nargs="?")
  customization_arguments.add_argument("--gisaid_submitter", help="GISAID submitter", default="", nargs="?")
  customization_arguments.add_argument("--submitter_email", help="Submitter email", default="", nargs="?")
